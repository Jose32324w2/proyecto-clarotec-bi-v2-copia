...
const PortalPage = () => {
    ...
    useEffect(() => {
        const fetchPedido = async () => {
            ...
            try {
                const response = await axios.get(`${config.API_URL}/portal/pedidos/${id_seguimiento}/`);
    ...
    const handleSelectShipping = async (method, cost) => {
        ...
        try {
            await axios.post(`${config.API_URL}/portal/pedidos/${id_seguimiento}/seleccionar-envio/`, {
                metodo_envio: method,
                costo: cost
            });
    ...
    const handleAction = async (accion) => {
        ...
        setError('');
        try {
            await axios.post(`${config.API_URL}/portal/pedidos/${id_seguimiento}/accion/`, { accion });
    ...
    const handleConfirmarRecepcion = async () => {
        ...
        setError('');
        try {
            await axios.post(`${config.API_URL}/portal/pedidos/${id_seguimiento}/confirmar-recepcion/`);
    ...
    const handleDownloadPDF = () => {
        window.open(`${config.API_URL}/pedidos/${pedido.id}/pdf/`, '_blank');
    };
